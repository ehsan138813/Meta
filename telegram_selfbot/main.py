...
async def main():
    ...
    if PHONE_NUMBER:
        ...
        if await owner_client.is_user_authorized():
            ...
            add_user_account(OWNER_ID, PHONE_NUMBER, session_path, OWNER_ID)
            print(f"✅ سلف‌بات ادمین روشن شد: {me.first_name} (@{me.username})")
        else:
            print("⚠️ سشن ادمین موجود نیست. برای لاگین از ربات استفاده کنید.")
